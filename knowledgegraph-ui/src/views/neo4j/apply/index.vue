    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="申请备注" prop="applyRemark">
          <el-input v-model="form.applyRemark" type="textarea" placeholder="请输入内容" disabled />
        </el-form-item>
        <el-form-item label="审核结果" prop="applyFlag">
...
<script>
import { listApply, getApply, delApply, addApply, updateApply } from "@/api/neo4j/apply";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('neo4j/apply/export', {
        ...this.queryParams
